...
if (confirm("Quer iniciar uma nova rodada?")){
   ...
   console.log(`Usuário - cartas: ${cartaUsuario1.texto} ${cartaUsuario2.texto} - pontuação: ${pontuacaoUser}`)
   console.log(`Usuário - cartas: ${cartaComputador1.texto} ${cartaComputador2.texto} - pontuação: ${pontuacaoComputador}`)
